...
<section class="category">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <a href="bunkee.php" class="btn">read more</a>
        </div>
        ...
        <div class="box">
            ...
            <h3>zip lines</h3>
            <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Laborum, id.</p>
            <a href="zip-lines.php" class="btn">read more</a>
        </div>
        ...
        <div class="box">
            ...
            <h3>Canoeing</h3>
            <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Laborum, id.</p>
            <a href="canoeing.php" class="btn">read more</a>
        </div>
        ...
        <div class="box">
            ...
            <h3>kayaking</h3>
            <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Laborum, id.</p>
            <a href="kayaking.php" class="btn">read more</a>
        </div>
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide slide">
                <div class="image">
                    ...
                    <div class="icons">
                        <a href="contact.php" class="fas fa-shopping-cart"></a>
                        <a href="contact.php" class="fas fa-eye"></a>
                        <a href="contact.php" class="fas fa-share"></a>
                    </div>
                </div>
                <div class="content">
                    <h3>survival kits</h3>
                    <div class="price"> 500 - 900 </div>
                    <div class="stars">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <div class="content">
                ...
                <div class="price">2500 - 4500</div>
                <a href="contact.php" class="btn">explore now</a>
            </div>
        </div>
